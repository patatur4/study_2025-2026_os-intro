...
- Сделайте отчёт по второй лабораторной работе в Markdown.
...
Выполненяю отчет по работе. (рис. -@fig:002)

![Выполнение отчета по лабораторной работе](image/2.png){#fig:002 width=70%}
